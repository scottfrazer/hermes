...
def lex_c(test_dir):
    ...
    try:
        ...
        command = 'gcc -o lexer -I/usr/local/include -I/usr/include -L/usr/local/lib -L/usr/lib -lpcre3 {sources} -g -Wall -pedantic -ansi -std=c99 2>&1'.format(sources=' '.join(c_files))
