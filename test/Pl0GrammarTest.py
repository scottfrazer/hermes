...
class Pl0GrammarTest(GrammarTest):
  ...
  def test_followSets(self):
    self.assertFollow({
      ...
      'block_const': set(['dot', 'var', 'semi']),
      'block': set(['dot', 'semi']),
      'block_var1': set(['semi']),
      'block_var': set(['dot', 'procedure', 'semi']),
      'number': set(['gteq', 'then', 'plus', 'var', 'equal', 'minus', 'semi', 'lt', 'times', 'lteq', 'rparen', 'do', 'dot', 'divide', 'gt', 'end', 'comma', 'pound']),
      'ident': set(['gteq', 'then', 'plus', 'assign', 'minus', 'equal', 'semi', 'lt', 'times', 'lteq', 'rparen', 'do', 'dot', 'comma', 'divide', 'gt', 'end', 'procedure', 'pound']),
